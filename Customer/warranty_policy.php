...
<div class="container pay">
    <div class="row">
        ...
        <p>
            ...
            tiếp tới các cửa hàng NXK Store để được tiếp nhận gửi máy bảo hành chính hãng.
        </p>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>12 tháng = Thời gian bảo hành còn lại tại hãng + Bảo hành tại NXK Store</td>
                <td><ul>
                        <li>Theo quyền lợi bảo hành của hãng trong thời gian được hãng bảo hành</li>
                        <li>Sửa chữa, thay thế linh kiện trong thời gian bảo hành còn lại tại NXK Store</li>
                    </ul></td>
                <td>TTBH chính hãng & NXK Store</td>
            </tr>
            <tr>
                <td>Máy cũ</td>
                <td>6 tháng</td>
        ...
        <ul>
            <li>Trung tâm bảo hành của các hãng, quý khách có thể xem chi tiết tại:
                <font>https://nxkstore.com.vn/bao-hanh/apple</font>
            </li>
        ...
        <p>Để được hỗ trợ trực tiếp với dịch vụ bảo hành, sửa chữa vui lòng liên hệ
            tổng đài: <font><a href="tel: 0976789999">0976 789 999</a> (miễn phí)</font></p>
