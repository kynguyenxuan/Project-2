...
<head>
    ...
    <title>NXK - Điện thoại chính hãng, giá tốt nhất</title>
</head>
<body>
                    ...
                    if (mysqli_num_rows($ktra_gh) != 0){
                        ...
                        if ($tangsl_sp){
                            echo "<div class='popupunder alert alert-success fade in'>
                                    ...
                                    <a href='cart.php' title='NXK'>Xem giỏ hàng của tôi</a>
                                  </div>";
                        ...
                        if ($themsp){
                            echo "<div class='popupunder alert alert-success fade in'>
                                    ...
                                    <i class='glyphicon glyphicon-remove'></i>
                                     ...
                                     <strong>Thông báo : </strong> Thêm sản phẩm vào giỏ hàng thành công ! <br>
                                    <a href='cart.php' title='NXKs2'>Xem giỏ hàng của tôi</a>
                                  </div>";
                            //echo "<script>alert('Thêm sản phẩm vào giỏ hàng thành công !')</script>";
                        }else{
    ...
    <div class="row product-details">
        ...
        <div class="col-md-5 details-left">
            ...
            <p>Bảo hành</p>
                ...
                Đổi mới trong 30 ngày tại <b><i>NXK Store</i></b> nếu có lỗi nhà sản xuất.
            ...
            <form method="post">
                <div class="form-group">
                 <textarea name="cmt-text" id="" cols="30" rows="10" class="form-control"
                   placeholder="Xin mời để lại câu hỏi, NXK Store sẽ trả lời trong 1h từ 8h - 22h mỗi ngày."></textarea>
                </div>
                <div class="form-group">
                            ...
                            <tr>
                                ...
                                border-radius: 5px;padding: 15px 15px 0;">
                                    ...
                                    text-align: left;left: 8px;">
                                            ...
                                            <img src="../Images/logo login.JPG" width="25" height="25" alt="">
                                ...
                                width: auto;padding: 10px 0 10px 30px;">
                                            NXK Store xin chào A/C <?php echo $num3['ho_ten'];?> ạ<br>
...
<a id="calltrap-btn" class="b-calltrap-btn calltrap_offline hidden-phone visible-tablet"
   href="tel:0976925608" data-toggle="tooltip" title="Gọi ngay cho tôi" data-placement="right">
