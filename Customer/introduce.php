...
<head>
    ...
    <title>NXKStore - Điện thoại chính hãng, giá tốt nhất</title>
</head>
<body>
...
<div class="container">
    ...
    <div class="row gioithieu">
        ...
        <h4><a href="Trangchu.php">NXK Store</a> là đối tác trực tiếp của các nhãn hàng và những nhà phân phối uy tín,
        ...
        <h4>
            Vì sao nên chọn NXK Store khi mua hàng cho doanh nghiệp:
        </h4>
        <p>
            <b>NXK Store</b> là <b>đối tác trực tiếp</b> của các nhãn hàng và những nhà phân phối uy tín,
        ...
        <ul>
            ...
            <li>Samsung Việt Nam, Vsmart, Nokia, Oppo, Xiaomi...</li>
            <li>Sony, PGI ( JBL, Harman Kardon ...), DTR ( Energizer, Mophie ... )</li>
            <li>NXK Store cung cấp hàng hoá với đầy đủ hoá đơn cũng như các giấy tờ theo yêu cầu
                của pháp luật Việt Nam.</li>
            <li>Với hơn 10 năm trong lĩnh vực bán lẻ, NXK Store chuyên nghiệp và linh hoạt trong việc
        ...
        <ul>
            <li>Mr.Xuân Kỷ (Hanoi) Mobile (Zalo, Viber, Telegram) : <a href="tel: 0976.925.608" class="text-danger">0976 925 608</a></li>
            <li>Tổng đài tư vấn miễn phí: <a href="tel:0976789999" class="text-danger">0976 789 999</a> hoặc email: Xuanki17@gmail.com</li>
        </ul>
...
<div class="row footer">
    ...
    <div class="fot col-md-3 col-sm-6 col-xs-6">
        ...
        <span>Điện thoại: <a href="tel: 0976925608">0976 925 608</a></span> <br>
        <i class="fas fa-phone-volume"></i>
        <span>Hotline: <a href="tel: 0976789999">0796 789 999</a></span> <br>
