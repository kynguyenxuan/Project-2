...
<div class="container">
    <div class="row change-delivery">
        <h3 class="text-center"><b>CHÍNH SÁCH VẬN CHUYỂN CỦA NXK STORE</b></h3>
        <h4><b>1. Đối với đơn hàng nội thành Hà Nội</b></h4>
        <p>NXK STORE miễn phí giao hàng đối với tất cả các đơn hàng trên TOÀN QUỐC.</p>
        <h4><b>2. Đối với đơn hàng ngoại thành HN và tỉnh lẻ</b></h4>
        <ul>
            <li>NXK STORE sử dụng dịch vụ chuyển phát trung gian
        ...
        <p>
            NXK STORE sử dụng dịch vụ xe của công ty giao hàng tận nơi. Tùy thuộc vào khoảng
