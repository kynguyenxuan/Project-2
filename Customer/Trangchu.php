...
<div class="row header">
    <div class="topnav" id="myTopnav" style="background-color: #FFB84C">
        ...
        if (isset($_SESSION['account']) or isset($_SESSION['avatar']))
        {
            ...
            echo "<a class='regis_log' href='profile_user.php'>
                  ...
                  <font style='color: #fff'>".$_SESSION['account']."</font></a>";
        }else
        {
            ?>
            ...
            <div id="myCarousel" class="carousel slide s1" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="../Images/samsung-s20-untral.png" alt="nxks2" style="width:100%;">
                    </div>
        ...
        <div class="logo_sp">
            ...
            while ($num1 = mysqli_fetch_array($dsdmsp_nine))
            {
                ...
                <a href="view_product_category.php?idxem=<?php echo $num1['id_dmsp'];?>">
                    <img src="../Images/<?php echo $num1['logo_dmsp'];?>" alt="nxk">
                </a>
            <?php    }
            ?>
        </div>
    ...
    ?>
            <div class="row">
                ...
                <a href="view_product_category.php?idxem=<?php echo $num4['id_dmsp'];?>" class="col-md-12 viewall">
                    <div class="view-all">Xem thêm điện thoại</div>
                </a>
            </div>
    <?php  } ?>
</div>
    ...
    <div id="float_content_right">
        ...
        <div class="kh-ib">
            ...
            <form method="post">
                ...
                <hr>
                <button type="submit" class="btn text-danger" name="send_ib" style="background-color: #FFB84C; color: #fff">Gửi tin nhắn</button>
            </form>
        </div>
