...
<div class="container pay">
    <div class="row">
        ...
        <p>
            ...
            bảo vệ hoặc xử lý tại <font>NXK Store</font>.
        </p>
        <h4>
        ...
        <p>Khi bạn đăng ký nhận bản tin, bạn có thể được yêu cầu cung cấp tên, địa chỉ email hoặc
            các thông tin khác của bạn để giúp NXK Store cải thiện việc cung cấp dịch vụ,
            thông tin khyến mãi.</p>
        <h4><b>Khi nào thông tin được thu thập?</b></h4>
        <p>NXK Store thu thập thông tin khi bạn đăng ký thành viên, hoặc đăng ký nhận bản tin.</p>
        <h4><b>Thông tin được lưu trong bao lâu?</b></h4>
        <p>Thông tin thành viên được lưu trữ từ khi bạn đăng ký hoặc cung cấp các thông
            tin này cho NXK Store qua các tính năng đăng ký. Thông tin thành viên,
            đăng ký sẽ được lưu trữ đến khi người dùng yêu cầu NXK Store hủy các thông tin này.</p>
        <h4><b>Thông tin của bạn được dùng làm gì?</b></h4>
        <p>NXK Store có thể sử dụng các thông tin thu thập từ bạn cho các mục đích sau:</p>
        <ul>
        ...
        <p>NXK Store sử dụng chứng chỉ SSL trong kết nối để bảo mật thông tin khách hàng trên website.</p>
        <h4><b>Việc sử dụng ‘cookie’?</b></h4>
        <p>NXK Store không sử dụng các cookie cho các mục đích theo dõi. Bạn có thể
            ...
            dịch vụ của của NXK Store có thể sẽ không phát huy hết các tính năng được thiết kế.</p>
        <h4><b>Các bên thứ ba</b></h4>
        <p>NXK Store không bán, trao đổi hoặc chuyển giao các thông tin đăng ký của bạn cho bất kỳ bên thứ ba nào.</p>
        <h4><b>NXK Store rất hân hạnh được phục vụ Quý khách!</b></h4>
    </div>
</div>
