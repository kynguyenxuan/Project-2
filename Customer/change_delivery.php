...
<div class="container">
    <div class="row change-delivery">
        <h3 class="text-center"><b>CHÍNH SÁCH ĐỔI - TRẢ - HOÀN TIỀN CỦA NXK STORE</b></h3>
        <h4><b>1. Chính sách trả hàng</b></h4>
        <p>Nhân viên NXK STORE giao hàng không đúng theo đơn đặt hàng của khách.</p>
        ...
        <p>Khách hàng vui lòng kiểm tra kĩ hàng hóa trước khi thanh toán hoặc ngay khi nhận hàng,
            NXK STORE sẽ không chịu trách nhiệm đối với hàng hóa bị lỗi không phải do nhà sản xuất
