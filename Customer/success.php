        ...
        <div class="main">
            <div class="col-main">
                ...
                <div class="module" style="border: solid 1px #eee; background: #fff; padding: 10px;">
                    <p>Cảm ơn Quý khách hàng đã chọn mua hàng tại NXK Store. Trong<b> 30 phút</b>, NXK Store sẽ <b>SMS hoặc Gọi</b> để xác nhận đơn hàng.</p>
                    <p>* Các đơn hàng từ <b> 21h tối tới 9h</b> sáng hôm sau, NXK Store sẽ liên hệ với Quý khách trước 12h trưa cùng ngày.</p>
