...
<div class="container pay">
    <div class="row">
        ...
        <div class="container pay-text">
            ...
            <ul>
                <li><b>Mr Xuan Ky</b></li>
                <li>Email: <font>Xuanki17@gmail.com</font></li>
            </ul>
            <p><b>Hợp tác với các kênh video Kỷ Nguyễn Xuân:</b></p>
            <ul>
                <li><b>Mr Xuan ky</b></li>
                <li>Email: <font>kynguyenxuan2869@gmail.com</font></font></li>
                <li>Link kênh: <a href="https://www.youtube.com/channel/UChNIgDcAIOjCLCuNtV4yURQ">
                        <font>https://www.youtube.com/channel/UChNIgDcAIOjCLCuNtV4yURQ</font>
                    </a></li>
            </ul>
            <h4><b>NXK STORE</b> xin cảm ơn và và kính mong hợp tác.</h4>
        </div>
    </div>
</div>
